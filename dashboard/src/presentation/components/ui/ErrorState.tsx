    ...
    <div className={container}>
      <div className="max-w-sm text-center">
        ...
        {onRetry && (
          <button
            onClick={onRetry}
            className="bg-accent-blue/10 text-accent-blue font-body hover:bg-accent-blue/20 focus-visible mt-2 rounded-lg px-4 py-2.5 text-sm font-medium transition-colors"
          >
            Reintentar
          </button>
        )}
